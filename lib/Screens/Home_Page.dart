...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    var kMinWidthOfLargeScreen=1000;
                            ...
                            Padding(
                              ...
                              child: CircleAvatar(
                                backgroundColor: MyColors.BackGround_Color1,
                                  ...
                                  backgroundImage: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7ZQOneke_lXuviB4oeiFUw1Fnk5h8HdDdZiEbo1tT950koDYOZ8GrVbSPPgKh83W46uw&usqp=CAU")
                                                              ...
                                                              child: SingleChildScrollView(
                                                                ...
                                                                child: Row(
                                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                                   ...
                                                                   Icon(Icons.notification_important_outlined,color: MyColors.Intro_Text_Color,),
                                                                      Column(
                                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(Notice[index]["notice"],style: TextStyle(color: MyColors.Intro_Text_Color),),
                                                                        ],
                                                                      )
                                                                    ],
                                                                ),
                                                  ...
                                                  width: MediaQuery.of(context)
                                                    ...
                                                    child: Column(
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                        mainAxisAlignment: MainAxisAlignment.start,
                                                        children: [
                                                          Container(height: 10,color: Color(0XFFf0f1f3),),
Padding(
  padding: const EdgeInsets.all(8.0),
  child:   Text("ALL EXAM RESULT",style: TextStyle(fontWeight: FontWeight.bold),),
),
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Container(
                                                            width: isScreenWide?30:10,
                                                            height:isScreenWide?30:10,
                                                            child: Image.network(
